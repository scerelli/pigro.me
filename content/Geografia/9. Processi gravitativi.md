...
---
## Altri processi gravitativi

### La Reptazione (Creep)

Il terreno subisce **movimenti impercettibili ma continui**, estremamente lenti (**mm/anno**), esponenziale decrescente con la profondità, azzerandosi a 1-2 metri di profondità. Il movimento è sempre verso valle per effetto della gravità.

**Meccanismo**: ogni piccola perturbazione (espansione, contrazione, sollevamento) sposta leggermente le particelle verso il basso, creando un **movimento netto progressivo**, vale a dire la somma di tutti i micro movimenti del terreno.

> [!Matematicamente]
> Σ(tutti i piccoli movimenti) × componente gravitazionale

**Fattori che causano la reptazione:**

**Processi Fisico-Chimici:**

- **Cicli gelo-disgelo**: espansione perpendicolare → contrazione verticale
- **Rigonfiamento-contrazione** di argille per variazioni di umidità
- **Variazioni termiche**: dilatazione-contrazione dei materiali

**Processi Biologici:**

- **Crescita e morte delle radici**: creano vuoti che si riempiono per gravità
- **Attività animali**: scavi di lombrichi, insetti, piccoli mammiferi
- **Bioturbazione**: mescolamento biologico del suolo

**Processi Idrologici:**

- **Cicli di imbibizione-essiccamento**: rigonfiamento e restringimento
- **Variazioni pressione interstiziale**: piccoli spostamenti delle particelle

**Effetto su neve** (**snow creep**):

- **Metamorfismo nivale**: ri-cristallizzazione e assestamento
- **Cicli termici**: fusione-rigelo superficiale

**Evidenze visibili:**

- **Pali e staccionate** che si inclinano gradualmente verso valle
- **Muri a secco** che si deformano lentamente
- **Alberi inclinati** sui versanti (ma le piante compensano durante la crescita)
- **"Terrazze di bovini"**: gradini formati dal calpestio animale + creep

**Velocità tipiche**: 0.5-10 mm/anno (estremamente lenta secondo classificazione Cruden-Varnes)

**Legge del creep**: la velocità è proporzionale alla pendenza e inversamente proporzionale alla coesione del materiale.

![[Pasted image 20250714123618.png]]

---
### DGPV (Deformazioni Gravitative Profonde di Versante)

Sono deformazioni molto profonde che interessano interi versanti montuosi. Queste sono impercettibili e lentissime, durano anche migliaia e migliaia di anni. Possono essere causate da molteplici fattori, quali:

#### Forze Destabilizzanti ↑

##### **Geometria del Versante:**

- **Pendenze eccessive**: >30-40° creano stress gravitativo elevato
- **Altezze elevate**: più materiale = più peso = più stress
- **Forma del versante**: concavità concentrano gli stress

##### **Sovraccarichi:**

- **Accumuli detritici** sulla sommità
- **Acqua infiltrata**: aumenta peso specifico del materiale
- **Ghiaccio/neve**: carichi stagionali aggiuntivi

#### Forze Stabilizzanti ↓

##### **Degradazione delle Rocce:**

- **Alterazione chimica**: dissoluzione cementi, formazione argille
- **Fratturazione fisica**: gelo-disgelo, variazioni termiche
- **Fatica del materiale**: stress ripetuti nel tempo

##### **Presenza di Acqua:**

- **Riduzione coesione**: lubrificazione delle fratture
- **Pressione interstiziale**: "solleva" le particelle riducendo attrito efficace
- **Cicli secco-umido**: rigonfiamento-contrazione delle argille

#### Rimozione Supporto alla Base

##### **Erosione Naturale:**

- **Erosione fluviale**: fiumi che incidono il piede del versante
- **Erosione glaciale**: ghiacciai che "scavano" le valli
- **Erosione marina**: onde che attaccano le falesie

##### **Decompressione Post-Glaciale:**

- **Ritiro ghiacciai**: perdita "buttress effect" (effetto contrafforte)
- **Rilascio tensionale**: rocce che si "rilassano" dopo compressione

> [!Note] Meccanicamente 
> **STABILITÀ**: Resistenza ≥ Stress Gravitativo  
> **INSTABILITÀ**: Resistenza < Stress Gravitativo

### Evoluzione del Fenomeno

#### Stadio Iniziale

- Roccia ancora **coesa** → oppone resistenza alla **deformazione**, si deforma elasticamente fino ad arrivare dopo molto tempo alla rottura
- Generalmente appaiono sui versanti le prime fratture **estensionali** poco pronunciate in sommità del versante, sotto **le** quali appaiono i primi **trench**
- **Velocità**: mm/anno

#### Stadio Intermedio

- La roccia passa ad un comportamento plastico → scende lentamente opponendo resistenza alla gravità, **con** velocità di deformazione costante nel tempo
- Lentissimi spostamenti differenziali su vari settori del versante **fanno sì che** la parte superiore del versante sprofondi mentre **quella** alla base **rigonfia** il versante **lateralmente**
- L'ammasso roccioso reagisce a queste deformazioni dilatandosi e comprimendosi:
    - **Nei settori alti** → prevale la **estensione** e gli spostamenti di porzioni di rocce lungo **piani** di taglio ben delineati, si accentuano sdoppiamenti delle creste e trench
    - **Nel settore mediano** l'aumento delle fratture fa aumentare le dimensioni per dilatazione e queste possono essere anche causa predisponente di gravi frane e crolli
    - **Alla base** prevale la compressione, ma poco evidente nell'area coinvolta
- **Velocità**: cm/anno

#### Stadio Avanzato

- Deformazione nei settori alti ancora maggiore → si **accentuano** trench e divisioni delle creste con l'aspetto **simile a** nicchie di frana
- Nella parte mediana **il fenomeno continua**, il rigonfiamento aumenta fino a che si vedono chiaramente **i limiti** del DGPV **e** le lingue di **deformazione** a causa del rigonfiamento
- Eventi eccezionali, quali intensa **piovosità** possono portare al crollo dell'intero versante
- Se c'è neve o **in cascata** intrappola ghiaccio può generare anche delle valanghe di roccia
- **Velocità**: dm/anno (prima di eventuale collasso)

### Zonazione Cinematica Tipica

Il versante si organizza in **tre zone principali**:

- **Zona estensionale** (settore alto): trincee, fratture, sdoppiamenti creste
- **Zona traslazionale** (settore medio): movimento uniforme, fratturazione diffusa
- **Zona compressiva** (settore basso): rigonfiamenti, sovrascorrimenti

### Morfologie Caratteristiche

- **Trincee (trenches)**: depressioni lineari parallele al versante
- **Contropendenze**: pendii rivolti verso monte (innaturali)
- **Scarpate**: gradini irregolari sui versanti
- **Dorsali spaccate**: creste montuose che si "aprono"
- **Deformazioni strutturali**: strati piegati e incurvati

![[Pasted image 20250714123504.png]]

![[Pasted image 20250714123541.png]]

---

## Soliflusso

**Processo di movimento lento e viscoso** (dello strato superficiale del suolo saturo d'acqua, facilitato dal **gelo-disgelo stagionale** e dall'**abbondante contenuto idrico**. In pratica un accellerazione dell'effetto [[9. Processi gravitativi#La Reptazione (Creep)|creep]] quando è saturo di acqua.

**Meccanismo**: quando lo strato superficiale si satura d'acqua (per piogge, fusione nevi, sorgenti) mentre quello sottostante rimane meno permeabile o gelato, si crea una **zona di scorrimento** che permette il movimento viscoso verso valle.

**Caratteristiche:**

- **Velocità**: cm/anno - dm/anno 
- **Profondità**: primi 0.5-2 metri di suolo
- **Dipendenza idrica**: attivo solo con saturazione d'acqua
- **Stagionalità**: più intenso durante disgelo primaverile

**Condizioni favorenti:**

- **Abbondante piovosità** o fusione nevi
- **Alternanza gelo-disgelo**: crea strato impermeabile sottostante
- **Suoli fini** (argillosi/limosi): trattengono più acqua
- **Pendenze moderate**: 5-20° (ottimali per flusso viscoso)
- **Presenza sorgenti** o ristagni

**Morfologie caratteristiche:**

- **Lobi di soliflusso**: gobbe allungate verso valle
- **Avvallamenti** tra i lobi
- **Terrazze** a gradini irregolari
- **Aspetto "a colata"** del versante

**Evoluzione possibile**: in presenza di **saturazione eccessiva** o **eventi piovosi intensi**, può accelerare trasformandosi in **colate di terra** o **scivolamenti superficiali**.

**Distribuzione**: tipico di **ambienti periglaciali** (alta montagna, zone artiche) e **versanti argillosi** in climi umidi.

![[Pasted image 20250714123743.png]]